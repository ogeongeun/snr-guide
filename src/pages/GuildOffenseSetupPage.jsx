...
const GuildOffenseSetupPage = () => {
  const userGroups = {
    ...
    '본성~내성(내성중 방어회수 높은애 공격)': ['렝차','나쁜남자 서동연','건근본','세숭e','함북이',"시기1"],
    '내성': [ 'purplesky','사랑이차차차','홍일기','이향','빈빈빈','오리시기'],
     '내성~외성(외성중 방어회수 높은애 공격)': ['풉키','구름머그믄빛','법원','갱자아빠','차사고낸놈','인생다이나믹','종아리'],
    '외성': ['야왕조조','NESTS','파워달봉','호두2','주브벨링엄'],
