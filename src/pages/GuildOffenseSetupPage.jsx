...
const GuildOffenseSetupPage = () => {
  const userGroups = {
    '1군': ['아도어','빈빈빈','신주노입니다','겁많아요','OneokRock','때오','렝차','JJJOUND','차윤다','뉴비호이호'],
    '2군': ['건근본','병살','이향','밤초','하이퍼울트라캡짱','오리시기','연발이','Arrow','삼각백조','버터1230호'],
    '3군': [ '나쁜남자 서동연','함북이','사랑이차차차','시기1','purplesky','파워달봉','법원','종아리','차사고낸놈','밀리엔']
