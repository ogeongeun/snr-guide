...
const GuildOffenseSetupPage = () => {
  const userGroups = {
    ...
    '본성~내성(내성중 방어회수 높은애 공격)': ['구름품은달','버터1230호','건근본','나쁜남자 서동연','세숭e'],
    '내성': [ 'purplesky','사랑이차차차','홍일기','이향','시기1','오리시기','풉키'],
     '내성~외성(외성중 방어회수 높은애 공격)': ['함북이','인생다이나믹','파워달봉','갱자아빠','야왕조조','NESTS'],
    '외성': ['종아리','주브벨링엄','법원','차사고낸놈','호두2'],
