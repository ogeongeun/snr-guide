...
const GuildOffenseSetupPage = () => {
  const userGroups = {
    '본성': ['아도어','하이퍼울트라캡짱','렝차','시기1','건근본'],
    '본성~내성(내성중 방어회수 높은애 공격)': ['이향','사랑이차차차','빈빈빈','버터1230호','오리시기',"겁많아요"],
    '내성': [ '오리시기','홍일기','구름머그믄빛','함북이','풉키'],
     '내성~외성(외성중 방어회수 높은애 공격)': ['purplesky','파워달봉','갱자아빠','세숭e','야왕조조','지옥신'],
    '외성': ['차사고낸놈','법원','인생다이나믹','호두2','NESTS','주브벨링엄'],
